...
* a class from an expression. You can use extends with any expression, and if the expression
* resolves to a function with [[Construct]] and a prototype, the class will work.
* */